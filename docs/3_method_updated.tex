...
$M$-term approximation \eqref{m-term} is selected over the union. Each
tile's selection is then completed to a complete binary sub-tree within its
own tree, as before. The allocation of terms across the tiles is therefore
